...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
    ...
    :custom
    (lsp-format-buffer-on-save nil)       ; Disable formatting on save
    ...
    (lsp-apply-edits-after-file-operations nil)    ; Solution from https://www.reddit.com/r/emacs/comments/1b0ppls/anyone_using_lspmode_with_tsls_having_trouble/
    ;; headerline
...
#+BEGIN_SRC emacs-lisp
  (use-package csv-mode
    ...
    :hook
    (csv-mode . (lambda ()
                  ;; Align fields automatically when opening
                  (csv-align-mode 1)))
    :config
    ;; Default separator (change to ?\; if you mostly edit semicolon-separated CSVs)
    (setq csv-separators '("," ";" "\t"))
